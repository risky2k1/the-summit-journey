...
Quy tắc nội dung:
- Không được tạo từ mới/sai chính tả; nếu không chắc, dùng từ đơn giản, phổ thông tiếng Việt.
...
-Rà soát lần cuối để đảm bảo không dính lỗi dính chữ, lỗi chính tả`;
